...
var _emberViewsViewsCore_view2 = _interopRequireDefault(_emberViewsViewsCore_view);

var _emberViewsMixinsView_context_support = require('ember-views/mixins/view_context_support');

var _emberViewsMixinsView_context_support2 = _interopRequireDefault(_emberViewsMixinsView_context_support);

var _emberViewsMixinsView_child_views_support = require('ember-views/mixins/view_child_views_support');

var _emberViewsMixinsView_child_views_support2 = _interopRequireDefault(_emberViewsMixinsView_child_views_support);

var _emberViewsMixinsView_state_support = require('ember-views/mixins/view_state_support');

var _emberViewsMixinsView_state_support2 = _interopRequireDefault(_emberViewsMixinsView_state_support);

var _emberViewsMixinsTemplate_rendering_support = require('ember-views/mixins/template_rendering_support');

var _emberViewsMixinsTemplate_rendering_support2 = _interopRequireDefault(_emberViewsMixinsTemplate_rendering_support);

var _emberViewsMixinsClass_names_support = require('ember-views/mixins/class_names_support');

var _emberViewsMixinsClass_names_support2 = _interopRequireDefault(_emberViewsMixinsClass_names_support);
...
var _emberViewsMixinsInstrumentation_support = require('ember-views/mixins/instrumentation_support');

var _emberViewsMixinsInstrumentation_support2 = _interopRequireDefault(_emberViewsMixinsInstrumentation_support);

var _emberViewsMixinsAria_role_support = require('ember-views/mixins/aria_role_support');

var _emberViewsMixinsAria_role_support2 = _interopRequireDefault(_emberViewsMixinsAria_role_support);

var _emberViewsMixinsVisibility_support = require('ember-views/mixins/visibility_support');

var _emberViewsMixinsVisibility_support2 = _interopRequireDefault(_emberViewsMixinsVisibility_support);

var _emberViewsCompatAttrsProxy = require('ember-views/compat/attrs-proxy');

var _emberViewsCompatAttrsProxy2 = _interopRequireDefault(_emberViewsCompatAttrsProxy);
...
_emberMetalCore2['default'].warn('The VIEW_PRESERVES_CONTEXT flag has been removed and the functionality can no longer be disabled.', _emberMetalCore2['default'].ENV.VIEW_PRESERVES_CONTEXT !== false);
...
var View = _emberViewsViewsCore_view2['default'].extend(_emberViewsMixinsView_context_support2['default'], _emberViewsMixinsView_child_views_support2['default'], _emberViewsMixinsView_state_support2['default'], _emberViewsMixinsTemplate_rendering_support2['default'], _emberViewsMixinsClass_names_support2['default'], _emberViewsMixinsLegacy_view_support2['default'], _emberViewsMixinsInstrumentation_support2['default'], _emberViewsMixinsVisibility_support2['default'], _emberViewsCompatAttrsProxy2['default'], _emberViewsMixinsAria_role_support2['default'], {
  ...
  */
  layout: (0, _emberMetalComputed.computed)('layoutName', {
    get: function get(key) {
      ...
      _emberMetalCore2['default'].assert('You specified the layoutName ' + layoutName + ' for ' + this + ', but it did not exist.', !layoutName || !!layout);
  ...
  templateForName: function templateForName(name, type) {
    if (!name) {
      return;
    }
  ...
  */
  ...
  /**
    ...
    @private
  */
  _classStringForProperty: function _classStringForProperty(parsedPath) {
  ...
  */
  $: function $(sel) {
    _emberMetalCore2['default'].assert('You cannot access this.$() on a component with `tagName: \'\'` specified.', this.tagName !== '');
    return this.currentState.$(this, sel);
  },

  forEachChildView: function forEachChildView(callback) {
  ...
  */
  appendTo: function appendTo(selector) {
    var target = (0, _emberViewsSystemJquery2['default'])(selector);

    _emberMetalCore2['default'].assert('You tried to append to (' + selector + ') but that isn\'t in the DOM', target.length > 0);
    _emberMetalCore2['default'].assert('You cannot append to an existing Ember.View. Consider using Ember.ContainerView instead.', !target.is('.ember-view') && !target.parents().is('.ember-view'));
  ...
  /**
    ...
    @private
  */
  renderToElement: function renderToElement(tagName) {
  ...
  /**
    ...
    @private
  */
  replaceIn: function replaceIn(selector) {
    var target = (0, _emberViewsSystemJquery2['default'])(selector);

    _emberMetalCore2['default'].assert('You tried to replace in (' + selector + ') but that isn\'t in the DOM', target.length > 0);
    _emberMetalCore2['default'].assert('You cannot replace an existing Ember.View. Consider using Ember.ContainerView instead.', !target.is('.ember-view') && !target.parents().is('.ember-view'));
  ...
  */
  ...
  /**
    ...
    @private
  */
  findElementInParentElement: function findElementInParentElement(parentElem) {
    var id = '#' + this.elementId;
    return (0, _emberViewsSystemJquery2['default'])(id)[0] || (0, _emberViewsSystemJquery2['default'])(id, parentElem)[0];
  },
  ...
  */
  ...
  /**
    ...
    @public
  */
  readDOMAttr: function readDOMAttr(name) {
  ...
  */
  ...
  scheduleRevalidate: function scheduleRevalidate(node, label, manualRerender) {
    if (node && !this._dispatching && node.guid in this.env.renderedNodes) {
      if (manualRerender) {
        _emberMetalCore2['default'].deprecate('You manually rerendered ' + label + ' (a parent component) from a child component during the rendering process. This rarely worked in Ember 1.x and will be removed in Ember 2.0');
      } else {
        _emberMetalCore2['default'].deprecate('You modified ' + label + ' twice in a single render. This was unreliable in Ember 1.x and will be removed in Ember 2.0');
      }
      _emberMetalRun_loop2['default'].scheduleOnce('render', this, this.revalidate);
      return;
    }

    _emberMetalCore2['default'].deprecate('A property of ' + this + ' was modified inside the ' + this._dispatching + ' hook. You should never change properties on components, services or models during ' + this._dispatching + ' because it causes significant performance degradation.', !this._dispatching);
  ...
  appendAttr: function appendAttr(node, buffer) {
  ...
  */
  _register: function _register() {
    _emberMetalCore2['default'].assert('Attempted to register a view with an id already in use: ' + this.elementId, !this._viewRegistry[this.elementId]);
  ...
  /**
    ...
    @private
  */
  _unregister: function _unregister() {
    delete this._viewRegistry[this.elementId];
  },

  registerObserver: function registerObserver(root, path, target, observer) {
  ...
  _wrapAsScheduled: function _wrapAsScheduled(fn) {
    var view = this;
    var stateCheckedFn = function stateCheckedFn() {
      view.currentState.invokeObserver(this, fn);
    };
    var scheduledFn = function scheduledFn() {
      _emberMetalRun_loop2['default'].scheduleOnce('render', this, stateCheckedFn);
    };
    return scheduledFn;
  }
});
...
var DeprecatedView = View.extend({
  init: function init() {
    this._super.apply(this, arguments);
    _emberMetalCore2['default'].deprecate('Ember.View is deprecated. Consult the Deprecations Guide for a migration strategy.', !!_emberMetalCore2['default'].ENV._ENABLE_LEGACY_VIEW_SUPPORT, { url: 'http://emberjs.com/deprecations/v1.x/#toc_ember-view' });
  }
});

exports['default'] = View;
exports.ViewContextSupport = _emberViewsMixinsView_context_support2['default'];
exports.ViewChildViewsSupport = _emberViewsMixinsView_child_views_support2['default'];
exports.ViewStateSupport = _emberViewsMixinsView_state_support2['default'];
exports.TemplateRenderingSupport = _emberViewsMixinsTemplate_rendering_support2['default'];
exports.ClassNamesSupport = _emberViewsMixinsClass_names_support2['default'];
