...
var STRING_DASHERIZE_CACHE = new _emberMetalCache2['default'](1000, function (key) {
...
var CAMELIZE_CACHE = new _emberMetalCache2['default'](1000, function (key) {
...
var CLASSIFY_CACHE = new _emberMetalCache2['default'](1000, function (str) {
...
var UNDERSCORE_CACHE = new _emberMetalCache2['default'](1000, function (str) {
  return str.replace(STRING_UNDERSCORE_REGEXP_1, '$1_$2').replace(STRING_UNDERSCORE_REGEXP_2, '_').toLowerCase();
});

var STRING_CAPITALIZE_REGEXP = /(^|\/)([a-z])/g;

var CAPITALIZE_CACHE = new _emberMetalCache2['default'](1000, function (str) {
...
var DECAMELIZE_CACHE = new _emberMetalCache2['default'](1000, function (str) {
...
function loc(str, formats) {
  ...
  str = _emberMetalCore2['default'].STRINGS[str] || str;
