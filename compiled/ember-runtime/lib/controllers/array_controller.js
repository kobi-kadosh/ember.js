...
exports['default'] = _emberRuntimeSystemArray_proxy2['default'].extend(_emberRuntimeMixinsController2['default'], _emberRuntimeMixinsSortable2['default'], {
  ...
  */
  ...
  arrayContentDidChange: function arrayContentDidChange(idx, removedCnt, addedCnt) {
    ...
    if (subControllers.length) {
      ...
      (0, _emberMetalReplace2['default'])(subControllers, idx, removedCnt, new Array(addedCnt));
    }
  ...
  init: function init() {
    _emberMetalCore2['default'].deprecate(arrayControllerDeprecation);
    this._super.apply(this, arguments);
  ...
  model: (0, _emberMetalComputed.computed)({
    ...
    set: function set(key, value) {
      _emberMetalCore2['default'].assert('ArrayController expects `model` to implement the Ember.Array mixin. ' + 'This can often be fixed by wrapping your model with `Ember.A()`.', _emberRuntimeMixinsArray2['default'].detect(value) || !value);
  ...
  */
  ...
  controllerAt: function controllerAt(idx, object, controllerClass) {
    ...
    if (!container._registry.has(fullName)) {
      throw new _emberMetalError2['default']('Could not resolve itemController: "' + controllerClass + '"');
    }
  ...
  _resetSubControllers: function _resetSubControllers() {
    var controller;
    var subControllers = this._subControllers;
