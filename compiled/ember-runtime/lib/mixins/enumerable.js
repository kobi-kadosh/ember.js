...
exports['default'] = _emberMetalMixin.Mixin.create({
  ...
  */
  ...
  /**
    ...
    @private
  */
  filterBy: function filterBy(key, value) {
  ...
  /**
    ...
    @private
  */
  rejectBy: function rejectBy(key, value) {
    var exactValue = function exactValue(item) {
  ...
  */
  ...
  /**
    ...
    @public
  */
  isEvery: function isEvery(key, value) {
  ...
  */
  ...
  /**
    ...
    @private
  */
  isAny: function isAny(key, value) {
  ...
  */
  ...
  /**
    ...
    @private
  */
  addEnumerableObserver: function addEnumerableObserver(target, opts) {
  ...
  /**
    ...
    @private
  */
  removeEnumerableObserver: function removeEnumerableObserver(target, opts) {
    var willChange = opts && opts.willChange || 'enumerableWillChange';
    var didChange = opts && opts.didChange || 'enumerableDidChange';
    var hasObservers = (0, _emberMetalProperty_get.get)(this, 'hasEnumerableObservers');
  ...
  */
  ...
  /**
    ...
    @private
  */
  enumerableContentWillChange: function enumerableContentWillChange(removing, adding) {
  ...
  /**
    ...
    @private
  */
  enumerableContentDidChange: function enumerableContentDidChange(removing, adding) {
    var removeCnt, addCnt, hasDelta;
  ...
  sortBy: function sortBy() {
    ...
    return this.toArray().sort(function (a, b) {
      for (var i = 0; i < sortKeys.length; i++) {
        ...
        var compareValue = (0, _emberRuntimeCompare2['default'])(propA, propB);
