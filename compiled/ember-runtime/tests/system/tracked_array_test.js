...
var trackedArray;
var RETAIN = _emberRuntimeSystemTracked_array2['default'].RETAIN;
var INSERT = _emberRuntimeSystemTracked_array2['default'].INSERT;
var DELETE = _emberRuntimeSystemTracked_array2['default'].DELETE;

QUnit.module('Ember.TrackedArray');

QUnit.test('operations for a tracked array of length n are initially retain:n', function () {
  trackedArray = new _emberRuntimeSystemTracked_array2['default']([1, 2, 3, 4]);
...
QUnit.test('inserts can expand (split/compose) inserts', function () {
  trackedArray = new _emberRuntimeSystemTracked_array2['default']([]);
...
QUnit.test('deletes compose with several inserts and retains and an adjacent delete', function () {
  trackedArray = new _emberRuntimeSystemTracked_array2['default']([1, 2, 3, 4, 5]);
...
QUnit.test('deletes can trim retains on the right', function () {
  trackedArray = new _emberRuntimeSystemTracked_array2['default']([1, 2, 3]);
...
QUnit.test('deletes can trim inserts on the left while composing with a delete on the left', function () {
  trackedArray = new _emberRuntimeSystemTracked_array2['default'](['a']);
  trackedArray.removeItems(0, 1);
