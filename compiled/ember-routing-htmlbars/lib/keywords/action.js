...
var _emberRoutingHtmlbarsKeywordsClosureAction2 = _interopRequireDefault(_emberRoutingHtmlbarsKeywordsClosureAction);
...
exports['default'] = function (morph, env, scope, params, hash, template, inverse, visitor) {
  if ((0, _emberMetalFeatures2['default'])('ember-routing-htmlbars-improved-actions')) {
    ...
    return (0, _emberRoutingHtmlbarsKeywordsClosureAction2['default'])(morph, env, scope, params, hash, template, inverse, visitor);
  } else {
    (0, _htmlbarsRuntimeHooks.keyword)('@element_action', morph, env, scope, params, hash, template, inverse, visitor);
    return true;
  }
