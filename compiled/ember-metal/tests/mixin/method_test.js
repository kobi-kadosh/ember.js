...
QUnit.test('overriding public methods', function () {
  ...
  obj = { publicMethod: function publicMethod() {
      return 'obj';
    } };
  MixinF.apply(obj);
...
QUnit.test('overriding toString', function () {
  ...
  obj = {};
  (0, _emberMetalMixin.mixin)(obj, { toString: function toString() {
      return 'FOO';
    } });
  equal(obj.toString(), 'FOO', 'should override toString w/o error');
});
...
QUnit.test('applying several mixins at once with sup already defined causes infinite loop', function () {
  ...
  var obj = {};
  (0, _emberMetalMixin.mixin)(obj, MixinA); // sup already exists
  (0, _emberMetalMixin.mixin)(obj, MixinB, MixinC); // must be more than one mixin
