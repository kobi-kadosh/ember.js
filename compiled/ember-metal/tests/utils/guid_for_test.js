...
var sameGuid = function sameGuid(a, b, message) {
  equal((0, _emberMetalUtils.guidFor)(a), (0, _emberMetalUtils.guidFor)(b), message);
};

var diffGuid = function diffGuid(a, b, message) {
  ok((0, _emberMetalUtils.guidFor)(a) !== (0, _emberMetalUtils.guidFor)(b), message);
};

var nanGuid = function nanGuid(obj) {
  var type = typeof obj;
  ok(isNaN(parseInt((0, _emberMetalUtils.guidFor)(obj), 0)), 'guids for ' + type + 'don\'t parse to numbers');
};
