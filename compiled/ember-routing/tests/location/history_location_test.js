...
QUnit.module('Ember.HistoryLocation', {
  setup: function setup() {
    ...
    HistoryTestLocation = _emberRoutingLocationHistory_location2['default'].extend({
      history: FakeHistory
    });
  },
...
QUnit.test('base URL is removed when retrieving the current pathname', function () {
  ...
  HistoryTestLocation.reopen({
    init: function init() {
      ...
      (0, _emberMetalProperty_set.set)(this, 'location', mockBrowserLocation('/base/foo/bar'));
      (0, _emberMetalProperty_set.set)(this, 'baseURL', '/base/');
    },
...
QUnit.test('HistoryLocation.getURL() returns the current url, excluding both rootURL and baseURL', function () {
  ...
  HistoryTestLocation.reopen({
    init: function init() {
      ...
      (0, _emberMetalProperty_set.set)(this, 'location', mockBrowserLocation('/base/foo/bar'));
      (0, _emberMetalProperty_set.set)(this, 'rootURL', '/app/');
      (0, _emberMetalProperty_set.set)(this, 'baseURL', '/base/');
    }
  });
...
QUnit.test('HistoryLocation.getURL() includes location.search', function () {
  ...
  HistoryTestLocation.reopen({
    init: function init() {
      this._super.apply(this, arguments);
      (0, _emberMetalProperty_set.set)(this, 'location', mockBrowserLocation('/foo/bar?time=morphin'));
    }
  });
...
QUnit.test('HistoryLocation.getURL() includes location.hash', function () {
  ...
  HistoryTestLocation.reopen({
    init: function init() {
      this._super.apply(this, arguments);
      (0, _emberMetalProperty_set.set)(this, 'location', mockBrowserLocation('/foo/bar#pink-power-ranger'));
    }
  });
...
QUnit.test('HistoryLocation.getURL() includes location.hash and location.search', function () {
  ...
  HistoryTestLocation.reopen({
    init: function init() {
      this._super.apply(this, arguments);
      (0, _emberMetalProperty_set.set)(this, 'location', mockBrowserLocation('/foo/bar?time=morphin#pink-power-ranger'));
    }
  });
