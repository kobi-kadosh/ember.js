...
exports['default'] = {
  ...
  */
  create: function create(options) {
    ...
    _emberMetalCore2['default'].assert('Ember.Location.create: you must specify a \'implementation\' option', !!implementation);

    var implementationClass = this.implementations[implementation];
    _emberMetalCore2['default'].assert('Ember.Location.create: ' + implementation + ' is not a valid implementation', !!implementationClass);
  ...
  /**
   ...
   @private
  */
  registerImplementation: function registerImplementation(name, implementation) {
    _emberMetalCore2['default'].deprecate('Using the Ember.Location.registerImplementation is no longer supported. Register your custom location implementation with the container instead.', false);

    this.implementations[name] = implementation;
  },

  implementations: {},
  _location: _emberMetalEnvironment2['default'].location,
