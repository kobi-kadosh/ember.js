...
/**
  ...
  @public
*/
var Route = _emberRuntimeSystemObject2['default'].extend(_emberRuntimeMixinsAction_handler2['default'], _emberRuntimeMixinsEvented2['default'], {
  /**
  ...
  */
  _qp: (0, _emberMetalComputed.computed)(function () {
    ...
    var queryParameterConfiguraton = (0, _emberMetalProperty_get.get)(this, 'queryParams');
    ...
    if (definedControllerClass) {
      ...
      var controllerDefinedQueryParameterConfiguration = (0, _emberMetalProperty_get.get)(controllerProto, 'queryParams');
      var normalizedControllerQueryParameterConfiguration = (0, _emberRoutingUtils.normalizeControllerQueryParams)(controllerDefinedQueryParameterConfiguration);
      ...
      if ((0, _emberMetalFeatures2['default'])('ember-routing-route-configured-query-params')) {
        if (controllerDefinedQueryParameterConfiguration.length) {
          _emberMetalCore2['default'].deprecate('Configuring query parameters on a controller is deprecated. Migrate the query parameters configuration from the \'' + controllerName + '\' controller to the \'' + this.routeName + '\' route: ' + combinedQueryParameterConfiguration);
        }
      }
    } else if (hasRouterDefinedQueryParams) {
      // the developer has not defined a controller but *has* supplied route query params.
      // Generate a class for them so we can later insert default values
      var generatedControllerClass = (0, _emberRoutingSystemGenerate_controller.generateControllerFactory)(this.container, controllerName);
    ...
    for (var propName in combinedQueryParameterConfiguration) {
      ...
      if (Array.isArray(defaultValue)) {
        defaultValue = _emberMetalCore2['default'].A(defaultValue.slice());
      }

      var type = desc.type || (0, _emberRuntimeUtils.typeOf)(defaultValue);

      var defaultValueSerialized = this.serializeQueryParam(defaultValue, urlKey, type);
      var scopedPropertyName = controllerName + ':' + propName;
      var qp = {
        undecoratedDefaultValue: (0, _emberMetalProperty_get.get)(controllerProto, propName),
  ...
  */
  ...
  /**
    @private
      @method _stashNames
  */
  _stashNames: function _stashNames(_handlerInfo, dynamicParent) {
  ...
  */
  _activeQPChanged: function _activeQPChanged(qp, value) {
  ...
  */
  _updatingQPChanged: function _updatingQPChanged(qp) {
    var router = this.router;
  ...
  /**
    ...
    @public
  */
  paramsFor: function paramsFor(name) {
    ...
    var params = {};
    (0, _emberMetalMerge2['default'])(params, state.params[name]);
    (0, _emberMetalMerge2['default'])(params, getQueryParamsFor(route, state));
  ...
  /**
    ...
    @private
  */
  serializeQueryParamKey: function serializeQueryParamKey(controllerPropertyName) {
  ...
  */
  deserializeQueryParam: function deserializeQueryParam(value, urlKey, defaultValueType) {
    ...
    if (defaultValueType === 'boolean') {
      ...
      return _emberMetalCore2['default'].A(JSON.parse(value));
    }
    return value;
  },
  ...
  */
  _optionsForQueryParam: function _optionsForQueryParam(qp) {
  ...
  */
  ...
  /**
    ...
    @since 1.7.0
  */
  _reset: function _reset(isExiting, transition) {
    var controller = this.controller;
    controller._qpDelegate = (0, _emberMetalProperty_get.get)(this, '_qp.states.inactive');
  ...
  _actions: {
    ...
    finalizeQueryParamChange: function finalizeQueryParamChange(params, finalParams, transition) {
      ...
      for (var i = 0, len = qpMeta.qps.length; i < len; ++i) {
        ...
        controller._qpDelegate = (0, _emberMetalProperty_get.get)(route, '_qp.states.inactive');
  ...
  */
  ...
  /**
    ...
    @public
  */
  transitionTo: function transitionTo(name, context) {
    var router = this.router;
  ...
  */
  send: function send() {
    ...
    if (this.router || !_emberMetalCore2['default'].testing) {
      var _router;

      (_router = this.router).send.apply(_router, _toConsumableArray(args));
    } else {
      var name = args[0];
  ...
  /**
    ...
    @method setup
  */
  setup: function setup(context, transition) {
    var controller;
    ...
    if (!this.controller) {
      var propNames = (0, _emberMetalProperty_get.get)(this, '_qp.propertyNames');
      addQueryParamsObservers(controller, propNames);
      this.controller = controller;
    }

    if (this.setupControllers) {
      _emberMetalCore2['default'].deprecate('Ember.Route.setupControllers is deprecated. Please use Ember.Route.setupController(controller, model) instead.');
      this.setupControllers(controller, context);
    } else {
      var queryParams = (0, _emberMetalProperty_get.get)(this, '_qp');
      ...
      if (transition) {
        ...
        allParams.forEach(function (prop) {
          ...
          aQp.values = params;
          var cacheKey = (0, _emberRoutingUtils.calculateCacheKey)(aQp.prefix, aQp.parts, aQp.values);

          if (cache) {
            var value = cache.lookup(cacheKey, prop, aQp.undecoratedDefaultValue);
            (0, _emberMetalProperty_set.set)(controller, prop, value);
          }
        });
      }
    ...
    if (this.renderTemplates) {
      _emberMetalCore2['default'].deprecate('Ember.Route.renderTemplates is deprecated. Please use Ember.Route.renderTemplate(controller, model) instead.');
  ...
  */
  _qpChanged: function _qpChanged(prop, value, qp) {
    if (!qp) {
      return;
    }

    var cacheKey = (0, _emberRoutingUtils.calculateCacheKey)(qp.prefix || '', qp.parts, qp.values);
  ...
  */
  model: function model(params, transition) {
    ...
    if (!name && sawParams) {
      return (0, _emberRuntimeCopy2['default'])(params);
    } else if (!name) {
  ...
  store: (0, _emberMetalComputed.computed)(function () {
    ...
    return {
      find: function find(name, value) {
        ...
        _emberMetalCore2['default'].assert('You used the dynamic segment ' + name + '_id in your route ' + routeName + ', but ' + namespace + '.' + (0, _emberRuntimeSystemString.classify)(name) + ' did not exist and you did not override your route\'s `model` hook.', !!modelClass);

        if (!modelClass) {
          return;
        }

        _emberMetalCore2['default'].assert((0, _emberRuntimeSystemString.classify)(name) + ' has no method `find`.', typeof modelClass.find === 'function');
  ...
  */
  serialize: function serialize(model, params) {
    ...
    if (params.length === 1) {
      ...
      object = (0, _emberMetalGet_properties2['default'])(model, params);
    }
  ...
  */
  ...
  /**
    ...
    @public
  */
  controllerFor: function controllerFor(name, _skipAssert) {
    var container = this.container;
    ...
    _emberMetalCore2['default'].assert('The controller named \'' + name + '\' could not be found. Make sure that this route exists and has already been entered at least once. If you are accessing a controller not associated with a route, make sure the controller class is explicitly defined.', controller || _skipAssert === true);
  ...
  /**
    ...
    @private
  */
  generateController: function generateController(name, model) {
    var container = this.container;

    model = model || this.modelFor(name);

    return (0, _emberRoutingSystemGenerate_controller2['default'])(container, name, model);
  },
  ...
  /**
    ...
    @public
  */
  modelFor: function modelFor(name) {
    var route = this.container.lookup('route:' + name);
  ...
  */
  render: function render(_name, options) {
    _emberMetalCore2['default'].assert('The name in the given arguments is undefined', arguments.length > 0 ? !(0, _emberMetalIs_none2['default'])(arguments[0]) : true);

    var namePassed = typeof _name === 'string' && !!_name;
    var isDefaultRender = arguments.length === 0 || _emberMetalCore2['default'].isEmpty(arguments[0]);
    var name;
    ...
    _emberMetalRun_loop2['default'].once(this.router, '_setOutlets');
  },
  ...
  /**
    ...
    * `parentView`: the name of the view containing the outlet to clear
    ...
    @private
  */
  disconnectOutlet: function disconnectOutlet(options) {
    var outletName;
    var parentView;
  ...
  _disconnectOutlet: function _disconnectOutlet(outletName, parentView) {
  ...
  */
  teardownViews: function teardownViews() {
...
function buildRenderOptions(route, namePassed, isDefaultRender, name, options) {
  ...
  if (typeof controller === 'string') {
    ...
    if (!controller) {
      throw new _emberMetalError2['default']('You passed `controller: \'' + controllerName + '\'` into the `render` method, but no such controller could be found.');
    }
  }
  ...
  if (!ViewClass && !template) {
    _emberMetalCore2['default'].assert('Could not find "' + name + '" template or view.', isDefaultRender);
    if (LOG_VIEW_LOOKUPS) {
      var fullName = 'template:' + name;
      _emberMetalCore2['default'].Logger.info('Could not find "' + name + '" template or view. Nothing will be rendered', { fullName: fullName });
    }
  }
...
function getFullQueryParams(router, state) {
  ...
  (0, _emberMetalMerge2['default'])(state.fullQueryParams, state.queryParams);
...
function copyDefaultValue(value) {
  if (Array.isArray(value)) {
    return _emberMetalCore2['default'].A(value.slice());
  }
  return value;
}
...
function mergeEachQueryParams(controllerQP, routeQP) {
  ...
  for (var cqpName in controllerQP) {
    ...
    (0, _emberMetalMerge2['default'])(newControllerParameterConfiguration, controllerQP[cqpName]);
    (0, _emberMetalMerge2['default'])(newControllerParameterConfiguration, routeQP[cqpName]);
  ...
  for (var rqpName in routeQP) {
    ...
    (0, _emberMetalMerge2['default'])(newRouteParameterConfiguration, routeQP[rqpName], controllerQP[rqpName]);
...
function deprecateQueryParamDefaultValuesSetOnController(controllerName, routeName, propName) {
  _emberMetalCore2['default'].deprecate('Configuring query parameter default values on controllers is deprecated. Please move the value for the property \'' + propName + '\' from the \'' + controllerName + '\' controller to the \'' + routeName + '\' route in the format: {queryParams: ' + propName + ': {defaultValue: <default value> }}');
}
