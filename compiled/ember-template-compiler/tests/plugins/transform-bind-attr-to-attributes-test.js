...
QUnit.test('Using the `bind-attr` helper throws a deprecation', function () {
  ...
  expectDeprecation(function () {
    (0, _emberTemplateCompiler.compile)('<div {{bind-attr class=view.foo}}></div>', {
...
QUnit.test('Using the `bindAttr` helper throws a deprecation', function () {
  ...
  expectDeprecation(function () {
    (0, _emberTemplateCompiler.compile)('<div {{bindAttr class=view.foo}}></div>');
...
QUnit.test('asserts for <div class=\'foo\' {{bind-attr class=\'bar\'}}></div>', function () {
  ...
  expectAssertion(function () {
    ignoreDeprecation(function () {
      (0, _emberTemplateCompiler.compile)('<div class="foo" {{bind-attr class=view.foo}}></div>');
    });
...
QUnit.test('asserts for <div data-bar=\'foo\' {{bind-attr data-bar=\'blah\'}}></div>', function () {
  ...
  expectAssertion(function () {
    ignoreDeprecation(function () {
      (0, _emberTemplateCompiler.compile)('<div data-bar="foo" {{bind-attr data-bar=view.blah}}></div>');
    });
