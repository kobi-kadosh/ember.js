...
var _containerTestsContainer_helper = require('container/tests/container_helper');
...
QUnit.test('A registered factory returns the same instance each time', function () {
  ...
  var PostController = (0, _containerTestsContainer_helper.factory)();
...
QUnit.test('fallback for to create time injections if factory has no extend', function () {
  var registry = new _containerRegistry2['default']();
  var container = registry.container();
  var AppleController = (0, _containerTestsContainer_helper.factory)();
  var PostController = (0, _containerTestsContainer_helper.factory)();
...
QUnit.test('A factory type with a registered injection\'s instances receive that injection', function () {
  ...
  var container = registry.container();
  var PostController = (0, _containerTestsContainer_helper.factory)();
  var Store = (0, _containerTestsContainer_helper.factory)();
...
QUnit.test('A factory with both type and individual injections', function () {
  ...
  var PostController = (0, _containerTestsContainer_helper.factory)();
  var Store = (0, _containerTestsContainer_helper.factory)();
  var Router = (0, _containerTestsContainer_helper.factory)();
...
QUnit.test('A non-singleton instance is never cached', function () {
  var registry = new _containerRegistry2['default']();
  var container = registry.container();
  var PostView = (0, _containerTestsContainer_helper.factory)();
...
QUnit.test('Injecting a falsy value does not raise an error', function () {
  var registry = new _containerRegistry2['default']();
  var container = registry.container();
  var ApplicationController = (0, _containerTestsContainer_helper.factory)();
...
QUnit.test('The `_onLookup` hook is called on factories when looked up the first time', function () {
  ...
  var registry = new _containerRegistry2['default']();
  var container = registry.container();
  var Apple = (0, _containerTestsContainer_helper.factory)();

  Apple.reopenClass({
    _onLookup: function _onLookup(fullName) {
...
QUnit.test('A factory\'s lazy injections are validated when first instantiated', function () {
  ...
  var container = registry.container();
  var Apple = (0, _containerTestsContainer_helper.factory)();
  var Orange = (0, _containerTestsContainer_helper.factory)();

  Apple.reopenClass({
    _lazyInjections: function _lazyInjections() {
